      ...
      <div class="box-container">
         ...
         ?>
               <div class="box">
                  ...
                  <p> name: <span><?php echo $fetch_appointment_form['name']; ?></span> </p>
                  <?php
                  if (isset($fetch_appointment_form['number'])) {
                  ?>
                     <p> number: <span><?php echo $fetch_appointment_form['number']; ?></span> </p>
                  <?php
                  } else {
                     echo '<p> number: <span>N/A</span></p>';
                  }
                  ?>
                  <p> email: <span><?php echo $fetch_appointment_form['email']; ?></span> </p>
                  <?php
// if (isset($fetch_appointment_form['message'])) {
 ?>
<!-- //    <p> message: <span><?php echo $fetch_appointment_form['message']; ?></span> </p> -->
<?php
// } else {
//    // echo '<p> message: <span>N/A</span></p>';
// }
// ?>
<!-- <a href="admin_contacts.php?delete=<?php echo $fetch_appointment_form['id']; ?>" onclick="return confirm('delete this user?');" class="delete-btn">delete Appointment</a> -->
   
               </div>
         <?php
            };
         } else {
            echo '<p class="empty">you have no users logged-in Today!</p>';
         }
         ?>
      </div>
   </section>
