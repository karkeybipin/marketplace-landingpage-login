...
if(isset($_GET['delete'])){
   ...
   mysqli_query($conn, "DELETE FROM `communication` WHERE id = '$delete_id'") or die('query failed');
...
<section class="messages">
   ...
   <?php
      $select_message = mysqli_query($conn, "SELECT * FROM `communication`") or die('query failed');
